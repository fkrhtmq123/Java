...
public class StringMemberTest {
	...
	public static void main(String[] args) {
		...
		// indexOf, lastIndexof - 문자열에서 문자 인데스 번호 추출
		int idex1 = str.indexOf("e");
		int idex2 = str.lastIndexOf("e");
		
		System.out.println("문자열 str에서 앞에서 부터 문자 e의 인덱스 값 : "+idex1);
		System.out.println("문자열 str에서 뒤에서 부터 문자 e의 인덱스 값 : "+idex2);
		
		// replace - 문자열 교체
		String newStr = str.replace("Korea", "Busan");
		System.out.println("newStr : "+newStr);
		
		// valueOf - 일반 타입 변수를 문자열로 변환
		int     var1 = 1;
		double  var2 = 2.13;
		boolean var3 = true;
