...
public class OperatorTest {
	...
	public static void main(String[] args) {
		...
		boolean res5 = (var1 == var2); // var1이 var2 서로 같다.
		boolean res6 = (var1 != var2); // var1이 var2 서로 다르다.
		...
		// 논리연산자
		boolean r1 = (var1 > 0) && (var2 > 1); // var1은 0 보다 크고 그리고 var2는 1보다 크다.
		boolean r2 = (var1 > 0) && (var2 > 2); // var1은 0 보다 크고 그리고 var2는 2보다 크다.
		boolean r3 = (var1 > 0) || (var2 > 2); // var1은 0 보다 크고 또는 var2는 2보다 크다.
		boolean r4 = (var1 > 1) || (var2 > 2); // var1은 1 보다 크고 또는 var2는 2보다 크다.
